...
class RenderShrinkWrap extends RenderBox
    with
        ContainerRenderObjectMixin<RenderBox, ShrinkWrapParentData>,
        RenderBoxContainerDefaultsMixin<RenderBox, ShrinkWrapParentData> {
  ...
  void performLayout() {
    ...
    for (int i = 0; i < runCount; ++i) {
      ...
      while (child != null) {
        final ShrinkWrapParentData childParentData =
        child.parentData! as ShrinkWrapParentData;
